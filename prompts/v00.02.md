...
Reconstruct them into full items. If a fragment contains a `predicted_class`, use it to help group fragments together; fragments with different predicted classes rarely belong to the same item. Return ONLY a JSON array.
