...
if [ "$#" -ne 4 ]; then
    echo "Usage: $0 <model> <prompt_file> <sample_size> <seed>"
    exit 1
fi
...
# uv run python main.py classify -i "$FRAGMENTS_DIR" -p "prompts/classify.md" -o "data/1_interim/classified/$safe_run_id"
